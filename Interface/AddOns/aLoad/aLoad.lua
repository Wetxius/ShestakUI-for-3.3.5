...
SettingsDB.CreateBlizzard(loadf)
loadf:Hide()
...
SettingsDB.CreateBlizzard(reloadb)
...
SettingsDB.CreateBlizzard(addonf)
...
local makeList = function()
	local self = mainf
	SettingsDB.CreateBlizzard(scrollf)
	scrollf:SetBackdropColor(0, 0, 0, 0)
...
if not IsAddOnLoaded("!aSettings_GUI") then return end
