...
local damagestyle = true
local ctfont,ctfontsize,ctfontstyle=SettingsCF["media"].pixel_font,SettingsCF["media"].pixel_font_size,SettingsCF["media"].font_style
local damagefont=SettingsCF["media"].pixel_font
...
for i=1,3 do
	...
	f:SetFont(ctfont,ctfontsize*2,ctfontstyle)
	...
	if(i==1)then
		f:SetJustifyH"LEFT"
		f:SetPoint("BOTTOMLEFT", "oUF_Player", "TOPLEFT", -4, 50)
	elseif(i==2)then
		f:SetJustifyH"RIGHT"
		f:SetPoint("BOTTOMRIGHT", "oUF_Player", "TOPRIGHT", 4, 50)
	else
