if SettingsCF["unitframe"].plugins_healcomm ~= true then return end
--[[
...
local function Update(self)
	...
	local incHeals = self.HealCommOthersOnly and healcomm:GetOthersHealAmount(guid, healcomm.CASTED_HEALS, timeFrame) or not self.HealCommOthersOnly and healcomm:GetHealAmount(guid, healcomm.CASTED_HEALS, timeFrame) or 0
