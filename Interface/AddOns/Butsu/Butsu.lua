...
do
	...
	title:SetFont(SettingsCF["media"].pixel_font, SettingsCF["loot"].font_size, SettingsCF["media"].font_style)
	title:SetJustifyH("LEFT")
	title:SetPoint("TOPLEFT", Butsu, "TOPLEFT", 7, -7)
	Butsu.title = title
end
...
SettingsDB.CreateBlizzard(Butsu)
...
do
	...
	function _NS.CreateSlot(id)
		...
		count:SetFont(SettingsCF["media"].pixel_font, SettingsCF["loot"].font_size, SettingsCF["media"].font_style)
		count:SetText(1)
		frame.count = count
		...
		name:SetFont(SettingsCF["media"].pixel_font, SettingsCF["loot"].font_size, SettingsCF["media"].font_style)
	...
	function Butsu:AnchorSlots()
		...
		--self:SetHeight(math.max((shownSlots * frameSize + 16), 20)) -- Default
