...
Filger_Spells = {
	["DRUID"] = {
		{
			...
			-- Abolish Poison
			{ spellID = 2893, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Savage roar
		...
		
		{
			...
			-- Moonfire
			{ spellID = 48463, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Insect Swarm
			{ spellID = 48468, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Faerie Fire
			{ spellID = 770, size = 37, unitId = "target", caster = "all", filter = "DEBUFF" },
			-- Entangling Roots
			{ spellID = 26989, size = 37, unitId = "target", caster = "all", filter = "DEBUFF" },
			-- Earth and Moon
			{ spellID = 48511, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Rake
			{ spellID = 59886, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Rip
			{ spellID = 49800, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Lacerate
			{ spellID = 48568, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Pounce Bleed
			{ spellID = 49804, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Mangle (Cat)
			{ spellID = 48566, size = 37, unitId = "target", caster = "all", filter = "DEBUFF" },
			-- Mangle (Bear)
			{ spellID = 48564, size = 37, unitId = "target", caster = "all", filter = "DEBUFF" },
		},
	...
	["HUNTER"] = {
	...
	
		{
			...
			-- Serpent Sting
			{ spellID = 49001, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Scorpid Sting
			{ spellID = 3043, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Black Arrow
			{ spellID = 63672, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Explosive Shot
			{ spellID = 60053, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
		},
	...
	["MAGE"] = {
		...
		
		{
			...
			-- Ignite
			{ spellID = 12848, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Living Bomb
			{ spellID = 55360, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Arcane Blast
			{ spellID = 36032, size = 37, unitId = "player", caster = "player", filter = "DEBUFF" },
		},
		
		{
			...
			-- Missile Barrage
			{ spellID = 54490, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Clearcasting
	...
	["WARRIOR"] = {
		...
		
		{
			...
			-- Rend
			{ spellID = 47465, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Sunder Armor
			...
			-- Infected Wounds
			{ spellID = 48485, size = 37, unitId = "target", caster = "all", filter = "DEBUFF" },
			-- Frost Fever
			...
			-- Demoralizing Roar
			{ spellID = 48560, size = 37, unitId = "target", caster = "all", filter = "DEBUFF" },
			-- Curse of Weakness
			{ spellID = 50511, size = 37, unitId = "target", caster = "all", filter = "DEBUFF" },
		},
	...
	["SHAMAN"] = {
		{
			...
			-- Maelstorm Weapon
			{ spellID = 51532, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Shamanistic rage
			{ spellID = 30823, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Bloodlust
			{ spellID = 2825, size = 37, unitId = "player", caster = "all", filter = "BUFF" },
			-- Lightning Shield
			{ spellID = 49281, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Water Shield
			{ spellID = 57960, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Earth Shield
			{ spellID = 49284, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Heroism
			{ spellID = 32182, size = 37, unitId = "player", caster = "all", filter = "BUFF" },
			-- Innervate
			{ spellID = 29166, size = 37, unitId = "player", caster = "all", filter = "BUFF" },
		...
		},
		{
			...
			-- Earth Shock
			{ spellID = 49231, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Frost Shock
			{ spellID = 49236, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Flame Shock
			{ spellID = 49233, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
		},
		
		{
			...
			{ spellID = 12536, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Tidal Waves
			{ spellID = 51566, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Essence of Life
			{ spellID = 60062, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
		},
	...
	["PALADIN"] = {
		...
		
		{
			...
			-- Hammer of Justice
			{ spellID = 10308, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Judgement of Light
		...
		
		{
			...
			{ spellID = 54155, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Holy Shield
			{ spellID = 53601, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Infusion of Light
	...
	["PRIEST"] = {
		{
			...
			-- Power Word: Shield
			{ spellID = 48066, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Renew
			{ spellID = 25222, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Fade
			{ spellID = 586, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Fear Ward
			{ spellID = 6346, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Hand of Protection
            { spellID = 10278, size = 37, unitId = "player", caster = "all", filter = "BUFF" },
            -- Dispersion
            { spellID = 47585, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
            -- Inner Fire
            { spellID = 48168, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Innervate
			{ spellID = 29166, size = 37, unitId = "player", caster = "all", filter = "BUFF" },
			-- Bloodlust
			{ spellID = 2825, size = 37, unitId = "player", caster = "all", filter = "BUFF" },
			...
			{ spellID = 32182, size = 37, unitId = "player", caster = "all", filter = "BUFF" },
			-- Borrowed Time
			{ spellID = 52800, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Hyperspeed Accelerators
			{ spellID = 54999, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
		},
		
		{
			...
			-- Serendipity
			{ spellID = 63734, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Greatness
			{ spellID = 60234, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Essence of Life
			{ spellID = 60062, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
	...
	["WARLOCK"] = {
		{
			...
			-- Life Tap
			{ spellID = 63321, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Bloodlust
			{ spellID = 2825, size = 37, unitId = "player", caster = "all", filter = "BUFF" },
			-- Heroism
			{ spellID = 32182, size = 37, unitId = "player", caster = "all", filter = "BUFF" },
		...
		
		{
			...
			{ spellID = 47865, size = 37, unitId = "target", caster = "all", filter = "DEBUFF" },
			-- Ebon Plaguebringer
			{ spellID = 51161, size = 37, unitId = "target", caster = "all", filter = "DEBUFF" },
			-- Earth and Moon
			{ spellID = 48511, size = 37, unitId = "target", caster = "all", filter = "DEBUFF" },
			-- Curse of Tongues
			{ spellID = 11719, size = 37, unitId = "target", caster = "all", filter = "DEBUFF" },
			-- Curse of Exhaustion
		...
		
		{
			...
			-- Nether Protection
			{ spellID = 30302, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Greatness
	...
	["ROGUE"] = {	
		{	
			...
			-- Hunger For Blood
			{ spellID = 51662, size = 37, unitId = "player", caster = "player", filter = "BUFF" },
			-- Bloodlust
			{ spellID = 2825, size = 37, unitId = "player", caster = "all", filter = "BUFF" },
			-- Heroism
			{ spellID = 32182, size = 37, unitId = "player", caster = "all", filter = "BUFF" },
		...
		
		{
			...
			-- Rupture
			{ spellID = 48672, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Garrote
			{ spellID = 48676, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Kidney shot
			...
			-- Deadly Poison
			{ spellID = 57973, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Wound Poison
			{ spellID = 57978, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Crippling Poison
			{ spellID = 3408, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Mind-numbing Poison
			{ spellID = 5761, size = 37, unitId = "target", caster = "player", filter = "DEBUFF" },
		},
