...
----------------------------------------------------------------------------------------
if SettingsCF["toppanel"].bg_stats == true then
	-- Info panel
	local ileft = CreateFrame("Frame", "InfoLeft", UIParent)
	SettingsDB.CreatePanel(ileft, 350, SettingsCF["media"].pixel_font_size, unpack(SettingsCF["position"].bg_score))
		...
		for i=1, numScores do
			...
			if ( name ) then
				if ( name == UnitName("player") ) then
					...
					GameTooltip:AddDoubleLine(HONORABLE_KILLS..":", honorKills, 1, 1, 1)
					GameTooltip:AddDoubleLine(DEATHS..":", deaths, 1, 1, 1)
					GameTooltip:AddDoubleLine(HONOR_GAINED..":", honorGained, 1, 1, 1)
	...
	Text1:SetFont(SettingsCF["media"].pixel_font, SettingsCF["media"].pixel_font_size, SettingsCF["media"].font_style)
	...
	Text2:SetFont(SettingsCF["media"].pixel_font, SettingsCF["media"].pixel_font_size, SettingsCF["media"].font_style)
	...
	Text3:SetFont(SettingsCF["media"].pixel_font, SettingsCF["media"].pixel_font_size, SettingsCF["media"].font_style)
	...
	local function Update(self, t)
		...
		if int < 0 then
			...
			for i=1, numScores do
				...
				if ( name ) then
					if ( name == UnitName("player") ) then
						Text2:SetText(COMBAT_HONOR_GAIN.." : "..honorGained)
