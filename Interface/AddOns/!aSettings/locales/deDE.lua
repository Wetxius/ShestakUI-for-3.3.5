...
if SettingsDB.client == "deDE" then
	...
	L_GUI_MINIMAP_ICON_CL = "Kampflogprobleme beheben"
	L_GUI_MINIMAP_ICON_DBM = "DBM Testmodus"
	L_GUI_MINIMAP_ICON_HEAL = "Zu Heiler-Layout wechseln"
	L_GUI_MINIMAP_ICON_DPS = "Zu DPS-Layout wechseln"
	
	-- idChat
	L_CHAT_URL = "Link kopieren"
	L_CHAT_GUILD = "G"
	L_CHAT_PARTY = "P"
	...
	L_LOOT_FROZEN_ORB = "Gefrorene Kugel"
	...
	-- aSettings(Bind key)
	L_BIND_COMBAT = "Du kannst keine Tasten im Kampf belegen."
