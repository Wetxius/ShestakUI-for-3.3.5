...
local function CreateRollButton(parent, ntex, ptex, htex, rolltype, tiptext, ...)
	...
	txt:SetFont(SettingsCF["media"].pixel_font, SettingsCF["loot"].font_size, SettingsCF["media"].font_style)
...
local function CreateRollFrame()
	...
	bind:SetFont(SettingsCF["media"].pixel_font, SettingsCF["loot"].font_size, SettingsCF["media"].font_style)
	frame.fsbind = bind

	local loot = frame:CreateFontString(nil, "ARTWORK")
	loot:SetFont(SettingsCF["media"].pixel_font, SettingsCF["loot"].font_size, SettingsCF["media"].font_style)
...
label:SetFont(SettingsCF["media"].pixel_font, SettingsCF["loot"].font_size, SettingsCF["media"].font_style)
label:SetPoint("CENTER", anchor, 0, 1)
