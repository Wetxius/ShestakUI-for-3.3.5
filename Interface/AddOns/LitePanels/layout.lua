...
{   name = "LeftColorBar", parent = "LeftBlackBar",
    anchor_to = "CENTER",
    width = 1, height = SettingsCF["chat"].height - 3,
...
{	name = "StatContainer",
	...
	OnEnter = function(self) if SettingsCF["toppanel"].mouseover == true then self:SetAlpha(1) end end,
...
{	name = "AFK", anchor_to = "TOP", y_off = -210,
	...
	text = {
			{	string = L_PANELS_AFK, anchor_to = "TOP", y_off = -10,
				shadow = 0, outline = 3, font = SettingsCF["media"].pixel_font, size = SettingsCF["toppanel"].font_size,
			},
			{	string = function()
					if afk_timer then
				...
				shadow = 0, outline = 3, font = SettingsCF["media"].pixel_font, size = SettingsCF["toppanel"].font_size*2,
