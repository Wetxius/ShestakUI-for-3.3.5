...
local _BACKDROP = {
	...
	tile = false, tileSize = 0, edgeSize = SettingsDB.mult, 
...
do
	...
	function frame:VARIABLES_LOADED()
		...
		_DB = SavedOptions.UFPos or {}
		SavedOptions.UFPos = _DB
...
do
	...
	getBackdrop = function(obj, isHeader)
		...
		backdrop:SetPoint("TOPLEFT", header or obj, -2, 2)
		backdrop:SetPoint("BOTTOMRIGHT", header or obj, 2, -2)
		...
		name:SetFont(SettingsCF["media"].pixel_font, SettingsCF["unitframe"].font_size, SettingsCF["media"].font_style)
		...
		backdrop:SetBackdropColor(0, 0, 0, 0.7)
		backdrop:SetBackdropBorderColor(unpack(SettingsCF["media"].border_color))
