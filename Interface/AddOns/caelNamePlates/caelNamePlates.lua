...
local function CheckRoll(self, event, unit)
	...
	if event == "PLAYER_ENTERING_WORLD" then
		if SettingsDB.myclass ~= "WARRIOR" and  SettingsDB.myclass ~= "DRUID" then
...
local createPlate = function(frame)
	...
	newNameRegion:SetFont(SettingsCF["media"].pixel_font, SettingsCF["nameplate"].font_size * offset, SettingsCF["media"].font_style)
	newNameRegion:SetTextColor(1, 1, 1)
	frame.name = newNameRegion
 
	frame.level = levelTextRegion
	levelTextRegion:SetFont(SettingsCF["media"].pixel_font, SettingsCF["nameplate"].font_size * offset, SettingsCF["media"].font_style)
	...
	if SettingsCF["nameplate"].health_value == true then
		...
		healthBar.percent:SetFont(SettingsCF["media"].pixel_font, SettingsCF["nameplate"].font_size * offset, SettingsCF["media"].font_style)
	...
	castBar.time:SetFont(SettingsCF["media"].pixel_font, SettingsCF["nameplate"].font_size * offset, SettingsCF["media"].font_style)
	castBar.time:SetPoint("RIGHT", castBar, "RIGHT", 0, 0.5)
	castBar.time:SetJustifyH("RIGHT")
 
	if SettingsCF["nameplate"].show_castbar_name == true then
		castBar.castName = castBar:CreateFontString(nil, "OVERLAY")
		castBar.castName:SetFont(SettingsCF["media"].pixel_font, SettingsCF["nameplate"].font_size * offset, SettingsCF["media"].font_style)
